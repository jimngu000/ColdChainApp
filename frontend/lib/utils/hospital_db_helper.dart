...
class HospitalDatabaseHelper {
    ...
    try {
      ...
      var hospitalDatabase =
          await openDatabase(path, version: 1,
            ...
            await db.execute("CREATE TABLE hospitals($colId INTEGER PRIMARY KEY, $colName TEXT, $colDistrict INTEGER, $colUser INTEGER);"),
          );
  ...
  Future<int> updateHospital(Hospital hospital) async {
    Database db = await database;
    return await db.update("hospitals", hospital.toMap(),
      where: '$colId = ?',
